...
Osor_cloud3.paint_uniform_color([1,1,0])
o3d.visualization.draw_geometries([sor_cloud3,Osor_cloud3])
o3d.io.write_point_cloud("plane.pcd", sor_cloud3)
o3d.io.write_point_cloud("line.pcd", Osor_cloud3)

#DBSCAN聚类
# 设置为debug调试模式
with o3d.utility.VerbosityContextManager(o3d.utility.VerbosityLevel.Debug) as cm:
    # -------------------密度聚类--------------------------
    labels = np.array(sor_cloud2.cluster_dbscan(eps=0.15,               # 邻域距离
                                         min_points=20,          # 最小点数
