...
# ----------------读取点云数据--------------
source = o3d.io.read_point_cloud("下采样A.pcd")
target = o3d.io.read_point_cloud("下采样B.pcd")
o3d.visualization.draw_geometries([source, target],width=600, height=600)  # 可视化原始结果
# -----------------计算的FPFH---------------
